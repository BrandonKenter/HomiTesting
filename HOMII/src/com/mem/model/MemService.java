...
public class MemService {
	...
	public MemVO updateMem(Integer member_no, String mb_name, String mb_email, String mb_pwd, byte[] mb_pic,
			 String mb_phone, String mb_address, String status, Date crt_dt) {
		...
		if((memVO.getStatus()!=null)||(memVO.getCrt_dt()!=null)){
	...
	public MemVO frontUpdateMem(Integer member_no, String mb_name, 
			 String mb_phone, String mb_address) {
...
//		memVO1.setMb_pwd(mb_pwd);
	...
	/*
	 * public List<MemVO> getAll(Map<String, String[]> map) { return
	 * dao.getAll(map); }
	 */
...
public class MemService {
	...
	public int accountActivate(String mb_email) {
		return dao.account_activate(mb_email);
	}
