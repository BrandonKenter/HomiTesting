...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/mem/mem.do" name="form1" data-toggle="validator">
			<div class="sign-in-htm">
				<div class="group form-group">
					...
					<input id="user" type="text" name="mb_email" class="input" value="<%= (memVO==null)? "" : memVO.getMb_email()%>" data-error="Format is incorrect" pattern="^[(a-zA-Z0-9_)]{2,20}[@][(a-zA-Z0-9)]{3,10}[.][(a-zA-Z)]{1,5}$" required="required" autocomplete="off">
				<div class="help-block with-errors"></div>
				</div>
				<div class="group form-group">
					<label for="pass" class="label">Password</label>
					<input id="pass" type="password" name="mb_pwd" class="input" data-type="password" value="<%= (memVO==null)? "" : memVO.getMb_pwd()%>" data-error="Please enter English or Digital number" pattern="^[(a-zA-Z0-9_)]{2,20}$" required="required" autocomplete="off">
				<div class="help-block with-errors"></div>
				</div>
<!-- 				<div class="group"> -->
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/mem/mem.do" name="form2" enctype="multipart/form-data" data-toggle="validator">
			<div class="sign-up-htm">
				...
				<div class="group form-group">
					...
					<input id="email" type="text" name="mb_email" class="input" value="<%= (memVO==null)? "" : memVO.getMb_email()%>" data-error="Please enter email" pattern="^[(a-zA-Z0-9_)]{2,20}[@][(a-zA-Z0-9)]{3,10}[.][(a-zA-Z)]{1,5}$" required="required" autocomplete="off">
				<div class="help-block with-errors"></div>
				</div>
				<div class="group form-group">
					<label for="pass2" class="label">Password</label>
					<input id="pass2" type="password" name="mb_pwd" class="input" data-type="password" value="<%= (memVO==null)? "" : memVO.getMb_pwd()%>" data-error="Please enter English or Digital number" pattern="^[(a-zA-Z0-9_)]{2,20}$" required="required" autocomplete="off">
				<div class="help-block with-errors"></div>
				</div>
				<div class="group form-group">
				...
				<div class="group form-group">
					<label for="membership" class="label">Register as</label>
					<input id="membership" type="radio" name="membership" value="0"> Tenant &nbsp <input id="membership" type="radio" name="membership" value="1"> Landlord
				<div class="help-block with-errors"></div>
				</div>
				<div class="group">
                          ...
                          <p>If you have forgotten your password you can reset it here.</p>
                            <div class="panel-body">
                                <fieldset>
                                        ...
                                        <div class="group form-group">
										<input id="email" type="text" name="mb_email" placeholder="E-mail Address" class="input form-control input-lg" value="<%= (memVO==null)? "" : memVO.getMb_email()%>" data-error="Foramt is incorrect" pattern="^[(a-zA-Z0-9_)]{2,20}[@][(a-zA-Z0-9)]{3,10}[.][(a-zA-Z)]{1,5}$" required="required" autocomplete="off">
										<div class="help-block with-errors"></div>
